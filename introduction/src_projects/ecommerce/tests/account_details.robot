...
# robot -d ./results -L trace  .\introduction\src_projects\ecommerce\tests\account_details.robot

*** Test Cases ***
Configurar Detalhes da Conta
    
    Navegar para      url=${URL_BASE}    url_complementar=/my-account/edit-account/
    Alterar detalhes da conta    Brendha    Ramos    Brendha Ramos
    Validar detalhes da conta no Dashboard        Brendha Ramos
