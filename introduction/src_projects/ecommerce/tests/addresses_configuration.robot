...
# robot -d ./results -L trace  .\introduction\src_projects\ecommerce\tests\addresses_configuration.robot

*** Test Cases ***
Configurar endereço de entrega
    
    Navegar para      url=${URL_BASE}    url_complementar=/my-account/edit-address/
    Alterar Endereço de entrega      street=Teste 123456    city=PR   state=Sao Paulo    postcode=34060-970    country=Brazil    phone=12345678
    Validar Endereço de entrega      street=Teste 123456    city=PR    state=Sao Paulo    postcode=34060-970    country=Brazil
